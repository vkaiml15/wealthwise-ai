"""
Portfolio Analysis Agent - Strands SDK Implementation
Converts the PortfolioAnalysisAgent to use Strands SDK patterns
"""
...
class StrandPortfolioAnalysisAgent:
    """
    Strands SDK Portfolio Analysis Agent
    Comprehensive portfolio analysis with health scoring and recommendations
    """
    ...
    def __init__(self):
        ...
        print("✅ [Strand Portfolio Agent] Initialized with model portfolios")
    ...
    def analyze_portfolio(self, user_email: str, market_data: Dict) -> Dict:
        ...
        Args:
            ...
            market_data: Output from StrandMarketDataAgent
        
        Returns:
            Complete analysis with recommendations
        """
        print("=" * 60)
        print(f"🤖 [Strand Portfolio Agent] Starting analysis")
        ...
        try:
            ...
            print("\n" + "=" * 60)
            print(f"✅ [Strand Portfolio Agent] Analysis Complete!")
            ...
            return {
                ...
                'agent': 'StrandPortfolioAnalysisAgent',
            ...
            print(f"❌ [Strand Portfolio Agent] Error in analysis: {e}")
            import traceback
            traceback.print_exc()
            return {
                'success': False,
    ...
    def get_user_profile(self, user_email: str) -> Optional[Dict]:
        ...
        try:
            ...
            if 'Item' in response:
                ...
                return convert_decimal_to_float(user)
            return None
        except Exception as e:
...
def create_portfolio_agent():
    """
    Factory function to create Strand Portfolio Analysis Agent
    
    Returns:
        StrandPortfolioAnalysisAgent instance
    """
    print("🏭 [Factory] Creating Strand Portfolio Analysis Agent...")
    
    agent = StrandPortfolioAnalysisAgent()
    
    print("✅ [Factory] Strand Portfolio Analysis Agent created successfully")
    return agent
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 60)
    print("🧪 TESTING STRAND PORTFOLIO ANALYSIS AGENT")
    print("=" * 60 + "\n")
    
    # Initialize agent
    agent = create_portfolio_agent()
    
    # Mock market data (simulating output from StrandMarketDataAgent)
    mock_market_data = {
        "success": True,
    ...
    if analysis['success']:
        ...
        print(f"🤖 Agent: {analysis['agent']} v{analysis['version']}")
